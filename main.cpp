...
int alpha_f(const gsl_vector *x, void *params, gsl_vector *f) {
  ...
  const double y0 = 1.2810167385645626 - (0.22222222222222224*x0)/(pow(x0,2) + pow(x1,2)) - 
    ...
    0.08642783212983116*log(pow(0.329423287332271 + x0,2) + pow(-0.21280498219449714 + x1,2)) - 
    0.19753086419753088*log(pow(x0,2) + pow(x1,2)) + 
    0.08642783212983116*log(pow(0.329423287332271 + x0,2) + pow(0.21280498219449714 + x1,2)) + 
    0.012337599968934259*log(pow(-0.14395661700847226 + x0,2) + pow(0.30687590223497346 + x1,2));
  const double y1 = 0.7853981633974483 + (0.22222222222222224*x1)/(pow(x0,2) + pow(x1,2)) + 
    ...
    0.1728556642596623*arg(complex<double>(0.329423287332271,-0.21280498219449714) + x0 + complex<double>(0,1)*x1) + 
    0.1728556642596623*arg(complex<double>(0.329423287332271,0.21280498219449714) + x0 + complex<double>(0,1)*x1) + 
...
int alpha_df(const gsl_vector *x, void *params, gsl_matrix *J) {
  ...
  const double df00 = -0.053350370503906966/(pow(-0.14395661700847226 + x0,2) + pow(-0.30687590223497346 + x1,2)) + 
   ...
   0.04902030508751202/(pow(0.329423287332271 + x0,2) + pow(-0.21280498219449714 + x1,2)) + 
   (0.1728556642596623*x0)/(pow(0.329423287332271 + x0,2) + pow(-0.21280498219449714 + x1,2)) + 
  ...
  const double df01 = -0.015788300674348502/(pow(-0.14395661700847226 + x0,2) + pow(-0.30687590223497346 + x1,2)) + 
   ...
   0.04904842844596766/(pow(0.329423287332271 + x0,2) + pow(-0.21280498219449714 + x1,2)) + 
   ...
   (0.1728556642596623*x1)/(pow(0.329423287332271 + x0,2) + pow(-0.21280498219449714 + x1,2)) - 
