...
!     call mnparm( 4,  'c8D8VpA', -0.17804d0,  0.4d-1, 0.d0, 0.d0, ierr)
      ...
      call mnparm( 1,    'astau',  0.3179d0,  0.2d-2, 0.d0, 0.d0, ierr)
      call mnparm( 2,   'aGGinv',  2.1000d-2,  1.0d-2, 0.d0, 0.d0, ierr)
      call mnparm( 3, 'rhoD6VpA', -0.15000d0,  0.10d0, 0.d0, 0.d0, ierr)
      call mnparm( 4,  'c8D8VpA',  0.24000d0,  0.30d0, 0.d0, 0.d0, ierr)
...
!                                    ! fluctuation analysis
      ...
      real(dp) :: chi2min, chi2n(Nsum), xmin(13)
...
!     write(6,*) "    R_tau,V+A = ", momex(1)
!     write(6,*) "del R_tau,V+A = ", sqrt(covex(1,1))
...
!     Employ uncertainty of R_VA = 3.4718(72)  (HFLAV 2017)
      cov0ex(1,1) = (0.0072d0)**2
...
!     Compute theoretical moments and covariances for V+A spectral function
