...
TEST_F(OPETest, D0CInt) {
  ...
  EXPECT_NEAR(ope_->D0CIntFO(2.6, Weight(6), 3.1570893124000001, 0.31927, 5), 0.28724759227498259, 1e-14);
  EXPECT_NEAR(ope_->D0CIntFO(2.6, Weight(6), 3.1570893124000001, 0.29, 5), 0.28350497970822786, 1e-14);
